...
-- 5. 创建hive的function
create function event_convert as 'com.beifeng.transformer.hive.EventDimensionUDF' using jar 'hdfs://hadoop-senior.ibeifeng.com:8020/beifeng/transformer/transformer-0.0.1.jar';  
