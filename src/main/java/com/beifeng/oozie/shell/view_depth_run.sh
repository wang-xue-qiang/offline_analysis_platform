...
/opt/cdh5.3.6/sqoop-1.4.5-cdh5.3.6/bin/sqoop export --connect jdbc:mysql://hadoop-senior.ibeifeng.com:3306/report --username hive --password hive --table stats_view_depth --export-dir /hive/stats_view_depth/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,date_dimension_id,kpi_dimension_id
