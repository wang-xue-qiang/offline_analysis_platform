...
/opt/cdh5.3.6/sqoop-1.4.5-cdh5.3.6/bin/sqoop export --connect jdbc:mysql://hadoop-senior.ibeifeng.com:3306/report --username hive --password hive --table stats_event --export-dir /hive/stats_event/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,data_dimension_id,event_dimension_id
